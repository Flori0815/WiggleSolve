        ...
        <div className="sidebar-content">
          {activeTab === 'elements' && (
            <div className="elements-tab">
              <section>
                <div className="section-header"><h3>Global Nodes</h3><button className="add-btn" onClick={() => { const id = prompt('ID:'); if(id){ system.addNode(new Node(id)); incrementVersion(); } }}>+</button></div>
              ...
              <section>
                <div className="section-header"><h3>Rigid Bodies</h3><button className="add-btn" onClick={() => { const id = prompt('ID:'); if(id){ system.addBody(new RigidBody(id)); incrementVersion(); } }}>+</button></div>
                {allBodyIds.length === 0 && (
          ...
          {activeTab === 'sequence' && (
            <div className="sequence-tab">
               <section>
                 <div className="section-header"><h3>Actuators</h3><button className="add-btn" onClick={() => { const id = prompt('ID:'); if(id) setActuators({...actuators, [id]: {id, type:'revolute', axis:'z', pivotNode:'', movingBodies:[], value:0}}); }}>+</button></div>
